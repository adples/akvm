...
<footer id="colophon" class="bg-foreground bg-linear-to-t from-bg-foreground to-stone-900 py-16 footer">
	<div class="mx-auto px-6 container">
		...
		<div class="flex lg:flex-row flex-col justify-between gap-12 lg:gap-6 text-white/75 text-sm">
			<div class="">
				&copy; <?php echo date("Y").' '.get_bloginfo().' All Rights Reserved.'; ?> | <a href="<?php echo esc_url(get_permalink(3)) ?>">Privacy Policy</a>
			</div>
		</div>
	</div>
</footer><!-- #colophon -->
