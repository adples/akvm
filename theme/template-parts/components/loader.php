...
@keyframes rotationBack {
	...
	.loader-overlay{
		...
		top: 0;
		left: 0;
		background-image: url('/wp-content/uploads/2025/11/bg-loader.jpg');
...
<div class="bg-foreground bg-linear-to-t from-bg-foreground to-stone-900 loader-overlay">
	<div class="loader-inner">
		<img src="http://akvm.test/wp-content/uploads/2025/11/akvm-logo-lg.png" alt="AKVM Logo" class="mx-auto mb"/>
