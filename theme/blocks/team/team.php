			...
			while ( have_rows( 'team' ) ) :
				...
				<div class="box-border p-6 w-1/2 lg:w-1/4 text-center">
					<?php if ( get_sub_field( 'img' ) ) : ?>
						<img src="<?php echo esc_url( get_sub_field( 'img' )['url'] ); ?>" class="block mx-auto !my-0 border-2 border-primary rounded-full w-20 not-prose" alt="" />
					<?php endif; ?>
					<?php if ( get_sub_field( 'title' ) ) : ?>
						<h4 class="my-0 not-prose"><?php echo wp_kses_post( get_sub_field( 'title' ) ); ?></h4>
					<?php endif; ?>
					<?php if ( get_sub_field( 'position' ) ) : ?>
						<h5 class="my-0 not-prose"><?php echo wp_kses_post( get_sub_field( 'position' ) ); ?></h5>
					<?php endif; ?>
